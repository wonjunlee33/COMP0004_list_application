...
@WebServlet("/runEditItemOne.html")
public class EditItemServletPartOne extends HttpServlet
{
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    ...
    if (idRequest != null) {
      ...
      // parse the item data to send to servlet:
      HashMap<String,String> itemToEdit = model.getSpecificItem(id);
      String itemToEditString = model.deFormatInput(itemToEdit);

      // send the string to servlet
      request.setAttribute("stringRequest", itemToEditString);
